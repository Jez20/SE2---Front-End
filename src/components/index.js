...
function Index() {
  ...
  <section className={dashboard.dashboard}>
    ...
    <i className={`${dashboard.sidebarToggle} uil uil-bars`} onClick={burger}/>
    ...
    <div id="clearOverlay" className={dashboard.clearOverlay}>
      <div className={dashboard.clearWrap}>
        ...
        <h2 id="clearh2">
          Performing this action is irreversable, Would you like to clear all
          logs?
        </h2>
        <form>
          <div className={dashboard.buttons}>
    ...
    <div id="updateHistoryOverlay" className={dashboard.updateHistoryOverlay}>
    ...
    <div id="deleteHistoryOverlay" className={dashboard.deleteHistoryOverlay}>
      <div className={dashboard.deleteHistoryWrap}>
        <h1 id="historyh1">
          <i className="bx bxs-error icon" /> Warning!{" "}
        </h1>
        <h2 id="historyh2">Would you like to delete the selected record?</h2>
        <form>
          <div className={dashboard.buttons}>
            <input
              className={`${dashboard.action_btn} ${dashboard.confirm}`}
