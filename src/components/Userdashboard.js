...
function Userdashboard() {
  ...
  const email = "student@gmail.com"; //ALSO CHANGE THIS ONE FOR A SPECIFIC EMAIL FOR THE PRINTING OF GENERATED BY IN PDF
  const dataa = {
    email: 'student@gmail.com' // HARDCODED USER EMAIL FOR TESTING PURPOSES!!!! DELETE AND UPDATE WHEN B.END IS FIXED!
...
<div>
  ...
  <section className="dashboard">
    ...
    <div className={inventory.dashContent}>
          ...
          <span className={inventory.text}>History Table</span>
        </div>
        <div className={`${inventory.activityData}`} style={{ overflowX: 'auto',marginTop: '20px'}}>
                <div className="scrollTable" style={{ minWidth: '100%', maxHeight: '285px'}}>
            ...
            <tbody>
              {userData.map((item, index) => (
                <tr key={index}>
                  ...
                  <td>{new Date(item.date_in).toLocaleString('en-US', {timeZone: 'Asia/Manila', year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit', second: '2-digit'})}</td>
                  <td>{new Date(item.date_out).toLocaleString('en-US', {timeZone: 'Asia/Manila', year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit', second: '2-digit'})}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <div className={inventory.title}>
          ...
          <span className={inventory.text}>Reservation Table</span>
        </div>
        <div className={inventory.inventory}>
                <p className="notef">*NOTE: Tick the Checkboxes and Click the Print Button to Print the Proof of Reservations</p>
              </div>
        {/* ROW 2 */}
        <div className={inventory.row2} style={{marginBottom: '30px'}}>
        ...
        <div className={`${inventory.activityData}`} style={{ overflowX: 'auto',marginTop: '20px'}}>
                <div className="scrollTable" style={{ minWidth: '100%', maxHeight: '294px'}}>
                  <table className={`${inventory.table}`} style={{ minWidth: '100%'}}>
